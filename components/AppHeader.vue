  ...
  <header class="absolute w-full z-30">
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div class="flex items-center justify-between h-16 md:h-20">
        ...
        <!-- Site branding -->
        <div class="shrink-0 mr-4 flex items-center" >
          <!-- Logo -->
          <NuxtLink class="block mr-4 " to="/" aria-label="Cruip">
          ...
          <span class="text-white">FastSend</span>
        </div>
        ...
        <nav class="flex grow">
          ...
          <ul class="flex grow justify-end flex-wrap items-center">
            <li>
              <NuxtLink class="font-medium text-slate-500 hover:text-slate-300 px-3 lg:px-5 py-2 flex items-center transition duration-150 ease-in-out" to="/">Sign in</NuxtLink>
            </li>
            <li class="ml-3">
              <NuxtLink class="btn-sm text-white bg-indigo-500 hover:bg-indigo-600 w-full shadow-xs group" to="/">
